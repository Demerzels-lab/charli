      ...
      <div className="shell py-14">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-4">
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-pretty text-sm leading-relaxed text-ink-soft">
              Open-source intelligence on public data. Read by Claude. For due
              diligence, not surveillance.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-line pt-6 text-xs text-ink-soft md:flex-row md:items-center md:justify-between">
          <p className="uppercase tracking-wider">
            CARLI · Open-Source Intelligence · Powered by Claude
          </p>
          <p>Open-source intelligence on public data. Not financial advice. DYOR.</p>
        </div>
      </div>
    </footer>
  );
