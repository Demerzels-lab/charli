...
const EXAMPLES: Array<{ label: string; query: string; delayMs: number; verdict: XAccountVerdict }> = [
  {
    ...
    verdict: {
      ...
      isVerified: true,
      metrics: { accountAgeDays: 5100, followers: 218000000, following: 900, usernameChanges: 0, firstCryptoMentionDays: null },
      signals: [
  ...
  },
  {
    ...
    verdict: {
      ...
      isVerified: false,
      metrics: { accountAgeDays: 6, followers: 14200, following: 12, usernameChanges: 3, firstCryptoMentionDays: 0 },
      signals: [
        { label: "Account age", value: "6 days old, explosive follower growth", direction: "bad" },
        { label: "Username changes", value: "3 changes in under a week", direction: "bad" },
        { label: "Crypto mentions", value: "First post was already a token shill", direction: "bad" },
      ],
      redFlags: ["Brand new account", "Rapid username churn", "No organic history before crypto pivot"],
      dataSources: { twitter: "available", memoryLol: "available" },
      dataCompleteness: "full",
    },
  },
